 ...
 *
 * minimumTimeTrajectoryGenerator_emxutil.h
 *
 * Code generation for function 'minimumTimeTrajectoryGenerator_emxutil'
 *
 */
...
/* End of code generation (minimumTimeTrajectoryGenerator_emxutil.h) */
