...
pAccel = [polyval(Traj(1, 1:10, 1), (time + 0.1:0.1:time + Traj(1, 11, 1)+0.1))', polyval(Traj(2, 1:10, 1), (time + 0.1:0.1:time + Traj(1, 11, 1)+0.1))', polyval(Traj(3, 1:10, 1), (time + 0.1:0.1:time + Traj(1, 11, 1)+0.1))'];
...
for z_index = (2:1:trajZ)
    ...
    pAccel = [pAccel; [polyval(polyder(polyder(Traj(1, 1:10, z_index))), (0.1:0.1:Traj(1, 11, z_index)+0.1))', polyval(polyder(polyder(Traj(2, 1:10, z_index))), (0.1:0.1:Traj(1, 11, z_index)+0.1))', polyval(polyder(polyder(Traj(3, 1:10, z_index))), (0.1:0.1:Traj(1, 11, z_index)+0.1))']];
